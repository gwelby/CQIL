...
class WaveParticleDuality {
    constructor(canvasId = 'wave-particle-canvas') {
        ...
        this.frequencies = [
            { 
                ...
                name: 'Ground State',
                rootwiz: 'Mycelial Pattern Recognition',
                description: 'Foundation frequency that connects to Earth\'s natural resonance. Creates hexagonal standing wave patterns that match mycelial networks.',
            ...
            { 
                ...
                name: 'Creation Point',
                rootwiz: 'φ-Harmonic Architecture',
                description: 'Known as the "miracle frequency" for DNA repair. Creates flower of life patterns that encode creation principles.',
            ...
            { 
                ...
                name: 'Heart Field',
                rootwiz: 'Quantum DNA Resonance',
                description: 'Heart-centered frequency that creates coherent emotional fields. Generates heart-shaped standing wave patterns.',
            ...
            { 
                ...
                name: 'Voice Flow',
                rootwiz: 'Sacred Sound Geometry',
                description: 'Activates authentic expression and cymatics manifestation. Creates complex mandala patterns in water and fine materials.',
            ...
            { 
                ...
                name: 'Vision Gate',
                rootwiz: 'Standing Stone Alignments',
                description: 'Enhances quantum perception and timeline viewing. Creates star-gate like geometrical networks in cymatics experiments.',
            ...
            { 
                ...
                name: 'Unity Wave',
                rootwiz: 'Quantum Integration Engine',
                description: 'Perfect toroidal field integration frequency. Unifies all other frequencies into coherent whole systems.',
    ...
    init() {
        ...
        this.rootwizInfo = {
            wave: {
                title: "Ground State (432 Hz)",
                component: "Mycelial Pattern Recognition",
                description: "Foundation frequency that connects to Earth's natural resonance. Creates hexagonal standing wave patterns that match mycelial networks."
            },
            particle: {
                title: "Creation Point (528 Hz)",
                component: "φ-Harmonic Architecture",
                description: "DNA repair frequency known as the 'miracle tone'. Creates crystalline structures and perfect geometric patterns that influence material reality."
            },
            quantum: {
                title: "Unity Wave (768 Hz)",
                component: "Quantum Integration Engine",
                description: "Highest integration frequency that creates toroidal energy fields. Represents the unified nature of quantum reality where wave and particle are one."
            }
        };
        ...
        console.log('Wave-Particle Duality initialized with Quantum Singularity ⚛️φ∞🌀');
    }
    ...
    toggleState(state) {
        ...
        // Mark active button
        if (this.buttons[`${state}Btn`]) {
            this.buttons[`${state}Btn`].classList.add('active');
        }
